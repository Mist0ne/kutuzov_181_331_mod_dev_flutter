...
//        redirectUri: 'https://www.facebook.com/v6.0/dialog/oauth?client_id=839610913196394&redirect_uri=https://www.facebook.com/connect/login_success.html&state=123456"',
//        customUriScheme: 'com.teranet.app'
//    );
//    return Scaffold(
//      body: Text(fbClient.authorizeUrl),
//    );
//  }
//
//}
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Center(child: Text("Hello ${profile.name}")),
    );
  }
}